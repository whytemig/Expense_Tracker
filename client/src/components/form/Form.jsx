...
const Form = () => {
  ...
  return (
    <form className="flex flex-col p-2" onSubmit={handleSubmit}>
      ...
      <button
        className="w-full px-4 py-2 border rounded-lg bg-[#00FF40] text-slate-900 font-semibold text-lg tracking-wide hover:text-slate-300 hover:bg-transparent hover:border-slate-300 transition-all duration-300 ease-in-out"
        type="submit"
        disabled={loading}
      >
